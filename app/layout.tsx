...
export const metadata: Metadata = {
  ...
  title: "Mahadev Bookie | Online Cricket , Casino & Sports ",
  description: "Join Mahadev Bookie for secure online cricket , live sports , casino games, instant IDs, competitive odds, and fast withdrawals in India.",
