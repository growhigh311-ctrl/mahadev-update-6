...
const fullFaqs = [
  ...
  {
    q: "How can I get a Lotus Book franchise?",
    a: "To obtain a franchise or master ID and start operating as a bookmaker partner under the Lotus Book brand, contact our corporate compliance desk through WhatsApp and ask for 'Franchise/Master ID details'. A verification agent will review your request."
  },
  {
  ...
  {
    q: "Is my personal information secure with Lotus Book?",
  ...
  {
    q: "Can I use Lotus Book on my mobile phone?",
  ...
  {
    q: "Is Lotus Book genuine or fake?",
    a: "Lotus Book is 100% genuine. We are India's oldest sports ID aggregator. Beware of copycat websites and phishing links; only use official routes sent by our verified WhatsApp agents."
  },
  {
    q: "What is the Lotus Book contact number?",
        ...
        <Reveal>
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 text-sm max-w-xl mx-auto font-light">
              Clear answers to the most common queries about Lotus Book account registration, rules, and withdrawals.
            </p>
